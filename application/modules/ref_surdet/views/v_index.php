...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			<div class="box-title">
				<h3><i class=" icon-plus-sign"></i>Survey Detail</h3>
			</div>

			<div class="box-content">
				<?php echo form_open('suburusan/index',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
...
<script>
	function kab_select(id){
		...
		$.ajax({
			url: '<?php echo site_url('ref_surdet/kec_index')?>',
			dataType: 'html',
			type    : 'POST',
	...
	function kec_select(id){
		...
		$.ajax({
			url: '<?php echo site_url('ref_surdet/kel_index')?>',
			dataType: 'html',
			type    : 'POST',
