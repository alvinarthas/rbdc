...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			<div class="box-title">
				<h3><i class=" icon-plus-sign"></i>Saksi Detail</h3>
			</div>
...
<script>
	function kab_select(id){
		...
		$.ajax({
			url: '<?php echo site_url('ref_sakdet/kab_index')?>',
			dataType: 'html',
			type    : 'POST',
	...
	function kec_select(id){
		...
		$.ajax({
			url: '<?php echo site_url('ref_sakdet/kec_index')?>',
			dataType: 'html',
			type    : 'POST',
	...
	function kel_select(id){
		...
		$.ajax({
			url: '<?php echo site_url('ref_sakdet/kel_index')?>',
			dataType: 'html',
			type    : 'POST',
