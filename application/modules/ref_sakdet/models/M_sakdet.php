...
class M_sakdet extends CI_Model{
	...
	public function super_masy_kab($id){
		$query = $this->db->query("SELECT ref_masy.id,no_tps,nama_lengkap,nama_panggilan,jns_kel,alamat,ktp,hp,ref_kabupaten.kabupaten,ref_kecamatan.kecamatan,ref_kelurahan.kelurahan,ref_pekerjaan.pekerjaan,ref_penghasilan.penghasilan,ref_umur.umur,ref_pendidikan.pendidikan,anggota_kel FROM ref_masy
