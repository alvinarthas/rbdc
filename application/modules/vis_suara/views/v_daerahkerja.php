...
<script>
    ...
    function kab_select(id){
        ...
        var jenis = "Grafik Kumulatif Riau Sebelum Memilih Kab/Kota - Kelurahan";
        ...
        if(aidi=="prov"){
            ...
            if(kategori == "*"){
                $.ajax({
                    url: '<?php echo site_url('vis_survey/all_kat')?>',
                    dataType: 'html',
                    type    : 'POST',
                ...
                $.ajax({
                    url: '<?php echo site_url('vis_survey/all_job')?>',
                    dataType: 'html',
                    type    : 'POST',
            ...
            if(kategori == "*"){
                $.ajax({
                    url: '<?php echo site_url('vis_survey/kat_all')?>',
                    dataType: 'html',
                    type    : 'POST',
                    data		: {'id_kab' : id,'kategori':kategori, 'daerah':daerah, 'jenis':jenis
                    },
                ...
                $.ajax({
                    url: '<?php echo site_url('vis_survey/kat_job')?>',
                    dataType: 'html',
                    type    : 'POST',
                    data		: {'id_kab' : id,'kategori':kategori, 'daerah':daerah, 'jenis2':jenis2, 'jenis':jenis
                    },
