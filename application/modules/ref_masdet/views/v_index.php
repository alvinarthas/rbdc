...
<div class="row-fluid">
	<div class="span12">
		<div class="box">
			<div class="box-title">
				<h3><i class=" icon-plus-sign"></i>Lihat Data Masyarakat</h3>
			</div>
...
<script>
	function kab_select(id){
		...
		$.ajax({
			url: '<?php echo site_url('ref_masdet/kab_index')?>',
			dataType: 'html',
			type    : 'POST',
	...
	function kec_select(id){
		...
		$.ajax({
			url: '<?php echo site_url('ref_masdet/kec_index')?>',
			dataType: 'html',
			type    : 'POST',
	...
	function kel_select(id){
		...
		$.ajax({
			url: '<?php echo site_url('ref_masdet/kel_index')?>',
			dataType: 'html',
			type    : 'POST',
